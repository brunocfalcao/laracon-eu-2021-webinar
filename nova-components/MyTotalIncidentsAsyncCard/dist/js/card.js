...
Nova.booting(function (Vue, router, store) {
  Vue.component('my-total-incidents-async-card', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetch: function fetch() {
            ...
            this.loading = true;
            Nova.request().get('/nova-vendor/my-total-incidents-async-card/endpoint', null).then(function (response) {
                _this.loading = false;
    ...
    [
      _c("div", { staticClass: "pl-6 py-3 flex items-center" }, [
        _c(
          ...
          {
            staticClass:
              "bg-red-500 w-16 h-16 flex items-center justify-center rounded-lg"
          },
          [
            _c("i", {
        ...
        _c("div", { staticClass: "pl-8" }, [
          _c("p", { staticClass: "text-2xl font-bold" }, [
            _vm._v(_vm._s(_vm.total) + " Incidents Total")
          ])
        ])
      ])
    ]
