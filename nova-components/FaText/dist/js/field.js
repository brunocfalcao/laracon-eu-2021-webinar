...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-fa-text', __webpack_require__(3));
  Vue.component('detail-fa-text', __webpack_require__(6));
  Vue.component('form-fa-text', __webpack_require__(9));
});
    ...
    [
      _c("template", { slot: "field" }, [
        _c(
          ...
          {
            staticClass:
              "flex items-center w-full form-control form-input form-input-bordered"
          },
          [
            _c("i", { class: this.field.icon_class }),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
